		...
		<div class="container">
			<div class="gallery-grids">
				<div class="col-md-4 gallery-grid">
					<div class="grid">
						<figure class="effect-roxy">
							<a class="example-image-link" href="home2/images/fr1.jpg" data-lightbox="example-set" data-title="">
								<img src="home2/images/fr1.jpg" alt="" />
								<figcaption>
									<h3><span>Grapes</span></h3>
				...
				<div class="col-md-4 gallery-grid">
					<div class="grid">
						<figure class="effect-roxy">
							<a class="example-image-link" href="home2/images/fr2.jpg" data-lightbox="example-set" data-title="">
								<img src="home2/images/fr2.jpg" alt="" />
								<figcaption>
				...
				<div class="col-md-4 gallery-grid">
					<div class="grid">
						<figure class="effect-roxy">
							<a class="example-image-link" href="home2/images/fr3.jpg" data-lightbox="example-set" data-title="">
								<img src="home2/images/fr3.jpg" alt="" />
								<figcaption>
				...
				<div class="col-md-4 gallery-grid">
					<div class="grid">
						<figure class="effect-roxy">
							<a class="example-image-link" href="home2/images/fr4.jpg" data-lightbox="example-set" data-title="">
								<img src="home2/images/fr4.jpg" alt="" />
								<figcaption>
									<h3><span>Sweet Lime</span></h3>
				...
				<div class="col-md-4 gallery-grid">
					<div class="grid">
						<figure class="effect-roxy">
							<a class="example-image-link" href="home2/images/fr5.jpg" data-lightbox="example-set" data-title="">
								<img src="home2/images/fr5.jpg" alt="" />
								<figcaption>
				...
				<div class="col-md-4 gallery-grid">
					<div class="grid">
						<figure class="effect-roxy">
							<a class="example-image-link" href="home2/images/fr6.jpg" data-lightbox="example-set" data-title="">
								<img src="home2/images/fr6.jpg" alt="" />
								<figcaption>
