...
<%@ page import="java.io.*" %>
<%Double yieldPredictionResult=(Double)request.getSession().getAttribute("yieldPredictionResult"); 
%> 
</head>
<body>
	<!-- banner -->
...
<div class="about-heading">	
		<div class="container">
			<h2>Crop Yield Prediction Based On Geographic Factors</h2>
		</div>
	
	<div class="blog">
	<div class="container">
	
		<h2><%="Your Expected Yield by considering all input parameters is : "%><u><%=yieldPredictionResult%> <%= "tons" %></u></h2>
			<div class="clearfix"> </div>
			</div>		
	</div>
	</div>
