				...
				<div class="col-md-12 agile-blog-grid">
					...
					<div class="agile-blog-grid">
						...
						<div class="blog-left-grids">
							...
							<div class="blog-left-right">
								<div class="blog-left-right-top">
									<h4><a href="#">Here is,How Maharashtras Farmers Are Proving Traditional Seeds Are the Best.</a></h4>
									<p>Posted By <a href="#">Admin</a> &nbsp;&nbsp; on Jan 12, 2019 &nbsp;&nbsp; </p>
								</div>
								<div class="blog-left-right-bottom">
									<p>Tribal households traditionally had a backyard garden that had multi purpose indigenous trees, plants, herbs, and shrubs. The produce from this small garden was sufficient to meet the food and nutritional needs of a family for an entire year,Sanjay Patil of BAIF Development Research Foundation, a Pune-based NGO working among tribes in 16 states of India, told VillageSquare.in.</p>
									<a href="blog02.jsp">More</a>
								</div>
							</div>
							<div class="clearfix"> </div>
						</div>
					...
					<div class="agile-blog-grid">
						...
						<div class="blog-left-grids">
							...
							<div class="blog-left-right">
								<div class="blog-left-right-top">
									<h4><a href="#">Modern Agricultural Practices A Dilemma of Farmers and Farm Workers Health in the Cash Crop Zone in the Maharashtra State</a></h4>
									<p>Posted By <a href="#">Admin</a> &nbsp;&nbsp; on Dec 16, 2018 &nbsp;&nbsp; </p>
								</div>
								<div class="blog-left-right-bottom">
									<p>Modern agriculture practices have a great promise for the economic development of a nation. In cash crop zones, modern agriculture tools and techniques have enriched farmers. The chemical pesticides and fertilizers (agrochemicals) are commonly used in Indian agriculture. Farm productivity is directly proportional to use of agrochemicals observed from the first green revolution. Improper and unsafe use of these agrochemicals especially pesticides are not only harmful to environment but also human health. </p>
									<a href="blog03.jsp">More</a>
								</div>
							</div>
							<div class="clearfix"> </div>
						</div>
