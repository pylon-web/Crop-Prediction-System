...
<html lang="en">
<head>
<title>Admin Resolve FAQ's</title>
			...
			<div class="col-md-8 agile-blog-grid-left">	
					<div class="agile-blog-grid">
						<div class="opinion">
							...
							<form action="FAQAnsServlet" method="post">
								<input type="text" name="farmerName" placeholder="Enter Farmer Name whom to answer" required="">
								<textarea name="ans" placeholder="Write Answer" required=""></textarea>
