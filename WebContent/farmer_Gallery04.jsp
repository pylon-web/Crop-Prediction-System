		...
		<div class="container">
			<div class="gallery-grids">
				<div class="col-md-4 gallery-grid">
					<div class="grid">
						<figure class="effect-roxy">
							<a class="example-image-link" href="images/ot1.png" data-lightbox="example-set" data-title="">
								<img src="images/ot1.png" alt="" />
								<figcaption>
									<h3><span>Sugarcane</span></h3>
				...
				<div class="col-md-4 gallery-grid">
					<div class="grid">
						<figure class="effect-roxy">
							<a class="example-image-link" href="images/ot2.jpg" data-lightbox="example-set" data-title="">
								<img src="images/ot
								2.jpg" alt="" />
								<figcaption>
									<h3><span>Wheat</span></h3>
				...
				<div class="col-md-4 gallery-grid">
					<div class="grid">
						<figure class="effect-roxy">
							<a class="example-image-link" href="images/ot3.jpg" data-lightbox="example-set" data-title="">
								<img src="images/ot3.jpg" alt="" />
								<figcaption>
									<h3><span>Jawhar</span></h3>
				...
				<div class="col-md-4 gallery-grid">
					<div class="grid">
						<figure class="effect-roxy">
							<a class="example-image-link" href="images/ot4.jpg" data-lightbox="example-set" data-title="">
								<img src="images/ot4.jpg" alt="" />
								<figcaption>
									<h3><span>Rice</span></h3>
				...
				<div class="col-md-4 gallery-grid">
					<div class="grid">
						<figure class="effect-roxy">
							<a class="example-image-link" href="images/ot5.jpg" data-lightbox="example-set" data-title="">
								<img src="images/ot5.jpg" alt="" />
								<figcaption>
									<h3><span>Soyabean</span></h3>
				...
				<div class="col-md-4 gallery-grid">
					<div class="grid">
						<figure class="effect-roxy">
							<a class="example-image-link" href="images/ot6.jpg" data-lightbox="example-set" data-title="">
								<img src="images/ot6.jpg" alt="" />
								<figcaption>
