						...
						<div class="blog-left-grids">
							...
							<div class="blog-left-right">
								...
								<div class="blog-left-right-bottom">
									...
									<p>The present study explores the hygienic problems of farmers and farm-workers caused by agrochemicals. For present study Kolhapur districts four villages were selected for drawing the facts of toxic effects of pesticides on farmers and farm workers health. For the present study data resources were collected from pilot tested structured interview techniques and group discussions.</p>	
									<p>This study attempts to analyze the handling of agro-chemicals and health related problems arising in the farmers and farm workers in the cash crop zone in Maharashtra state. There are several issues related with the application of agrochemicals for research inquiry. In this research article some of the core issues were tested to investigate the health problems and pesticide poisoning related death cases are well narrated. This study helps in shaping and designing of the policies.</p>
