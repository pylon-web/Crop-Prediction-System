		...
		<div class="container">
			<div class="agile-blog-grids">
				<div class="col-md-12 agile-blog-grid">
					...
					<div class="agile-blog-grid">
						<div class="agile-blog-grid-left-img">
							<video controls poster="images/post1.jpg">
							    <source src="videos/vb1.mp4" type="video/mp4">
					  			<source src="videos/vb1.mp4" type="video/ogg">
							</video>
						</div>
					...
					<div class="agile-blog-grid">
						<div class="agile-blog-grid-left-img">
							<video controls poster="images/post2.jpg">
							    <source src="videos/vb2.mp4" type="video/mp4">
					  			<source src="videos/vb21.mp4" type="video/ogg">
							</video>
						</div>
						<div class="blog-left-grids">
							<div class="blog-left-left">
							...
							<div class="blog-left-right">
								<div class="blog-left-right-top">
									<h4><a href="#">Coconut Farming.</a></h4>
									<p>Posted By <a href="#">Admin</a> &nbsp;&nbsp; on June 2, 2016 &nbsp;&nbsp;</p>
								</div>
					...
					<div class="agile-blog-grid">
						<div class="agile-blog-grid-left-img">
							<video controls poster="images/post3.jpg">
							    <source src="videos/vb3.mp4" type="video/mp4">
					  			<source src="videos/vb3.mp4" type="video/ogg">
							</video>
						</div>
						<div class="blog-left-grids">
							<div class="blog-left-left">
							...
							<div class="blog-left-right">
								<div class="blog-left-right-top">
									<h4><a href="#">Air Layer Technique.</a></h4>
									<p>Posted By <a href="#">Admin</a> &nbsp;&nbsp; on June 2, 2016 &nbsp;&nbsp;</p>
								</div>
