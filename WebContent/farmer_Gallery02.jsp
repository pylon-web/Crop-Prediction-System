		...
		<div class="container">
			<div class="gallery-grids">
				<div class="col-md-4 gallery-grid">
					<div class="grid">
						<figure class="effect-roxy">
							<a class="example-image-link" href="images/fl1.jpg" data-lightbox="example-set" data-title="">
								<img src="images/fl1.jpg" alt="" />
								<figcaption>
									<h3><span>Rose</span></h3>
				...
				<div class="col-md-4 gallery-grid">
					<div class="grid">
						<figure class="effect-roxy">
							<a class="example-image-link" href="images/fl2.jpg" data-lightbox="example-set" data-title="">
								<img src="images/fl2.jpg" alt="" />
								<figcaption>
									<h3><span>Lotus</span></h3>
				...
				<div class="col-md-4 gallery-grid">
					<div class="grid">
						<figure class="effect-roxy">
							<a class="example-image-link" href="images/fl3.jpg" data-lightbox="example-set" data-title="">
								<img src="images/fl3.jpg" alt="" />
								<figcaption>
									<h3><span>Lily</span></h3>
				...
				<div class="col-md-4 gallery-grid">
					<div class="grid">
						<figure class="effect-roxy">
							<a class="example-image-link" href="images/fl4.jpg" data-lightbox="example-set" data-title="">
								<img src="images/fl4.jpg" alt="" />
								<figcaption>
									<h3><span>Daisy</span></h3>
				...
				<div class="col-md-4 gallery-grid">
					<div class="grid">
						<figure class="effect-roxy">
							<a class="example-image-link" href="images/fl5.jpg" data-lightbox="example-set" data-title="">
								<img src="images/fl5.jpg" alt="" />
								<figcaption>
									<h3><span>Rose</span></h3>
				...
				<div class="col-md-4 gallery-grid">
					<div class="grid">
						<figure class="effect-roxy">
							<a class="example-image-link" href="images/fl6.jpg" data-lightbox="example-set" data-title="">
								<img src="images/fl6.jpg" alt="" />
								<figcaption>
									<h3><span>Tulip</span></h3>
