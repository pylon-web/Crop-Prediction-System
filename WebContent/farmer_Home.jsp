...
<!-- bootstrap-css -->
<link href="usercss/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
<!--// bootstrap-css -->
<!-- css -->
<link rel="stylesheet" href="usercss/css/style.css" type="text/css" media="all" />
<!--// css -->
<!-- font-awesome icons -->
<link href="usercss/css/font-awesome.css" rel="stylesheet"> 
<!-- //font-awesome icons -->
<!-- font -->
...
<!-- //font -->
<script src="usercss/js/jquery-1.11.1.min.js"></script>
<script src="usercss/js/bootstrap.js"></script>
...
<body>
	<div class="banner-top">
		<div class="slider">
			...
			<script src="usercss/js/responsiveslides.min.js"></script>
			<script>
	...
	<script src="usercss/js/responsiveslides.min.js"></script>
	<script src="usercss/js/SmoothScroll.min.js"></script>
	<script type="text/javascript" src="usercss/js/move-top.js"></script>
	<script type="text/javascript" src="usercss/js/easing.js"></script>
