		...
		<div class="container">
			...
			<div class="agileits-a-about-grids">
				...
				<div class="col-md-7 agileits-a-about-right">
					<h3>A few words about our Mentors</h3>
					<h4>Crop Recommendation Based On Local Environmental Parameters Using Machine Learning Approach.</h4>
					<p><span>The success of this project the outcome of the enormous contribution of various people involved directly or indirectly with project work. It is a pleasure to express our sincere thanks to them all. We are deeply indebted to our guide Prof.   for their inspiring guidance, encouragement and supervision to complete the project entitled Crop Recommendation Based On Local Environmental Parameters Using Machine Learning Approach, this project would never been possible without their guidance and supervision.</span>
									<span>We would like to express my gratitude towards member of our all team for their kind co-operation and encouragement which help me in completion of this project.</span>
					</p>
				</div>
				<div class="clearfix"> </div>
			</div>
	...
	<div class="team">
		<div class="container">
			<div class="agileinfo-team-heading">
				<h3>Project <span>Group Member's</span></h3>
			</div>
